...
// float StepMotor1_coef[6] = {5.336887, 0.107546, 0.006434, -0.000006, -0.000014, -0.000003};
float StepMotor1_coef[6] = {5.336887, 0.107546, 0.006434, -0.000006, -0.000014, -0.000003};
float StepMotor2_coef[6] = {53.214348, 0.005247, 0.130172, -0.000015, -0.000001, -0.000055};
...
void StepMotor_PID(StepMotor *motor, float target_angle, float current_angle)
{
  ...
  motor->target_speed = (uint16_t)(motor->pid_value / STEPMOTOR_ANGLE_PER_STEP) > (StepMotor_speedMAX - StepMotor_speedMIN) ? StepMotor_speedMAX : ((uint16_t)(motor->pid_value / STEPMOTOR_ANGLE_PER_STEP) + StepMotor_speedMIN); // 步进电机的目标速度
}
