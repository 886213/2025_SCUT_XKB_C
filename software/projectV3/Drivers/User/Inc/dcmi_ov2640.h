...
#define OV2640_Width LCD_W  // 图像长度
#define OV2640_Height LCD_H // 图像宽度
...
#define Display_Width LCD_W
#define Display_Height LCD_H
...
// void OV2640_DMA_Transmit_Continuous(uint16_t *buf0, uint16_t *buf1, uint32_t size);
