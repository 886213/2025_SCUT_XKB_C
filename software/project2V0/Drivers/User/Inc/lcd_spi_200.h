...
#define OPENMV_Width 320
#define OPENMV_Height 240
...
#define LCD_Backlight_PORT GPIOE                                   // 背光 GPIO端口
...
#define LCD_CS_PIN GPIO_PIN_9                              // 数据指令选择  引脚
#define LCD_CS_PORT GPIOE                                   // 数据指令选择  GPIO端口
#define GPIO_LDC_CS_CLK_ENABLE __HAL_RCC_GPIOE_CLK_ENABLE() // 数据指令选择  GPIO时钟
