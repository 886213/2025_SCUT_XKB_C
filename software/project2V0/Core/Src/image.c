...
//   // if(Scan_A4Target_Count < Scan_Num)
//   // {
//   //   Scan_A4Target_Count++;
//   //   A4Target_RightBottom.x = mid_Filter2_uint16(A4Target_RightBottom.x);
//   //   A4Target_RightBottom.y = mid_Filter2_uint16(A4Target_RightBottom.y);
//   //   A4Target_RightTop.x = mid_Filter2_uint16(A4Target_RightTop.x);
//   //   A4Target_RightTop.y = mid_Filter2_uint16(A4Target_RightTop.y);
//   //   A4Target_LeftBottom.x = mid_Filter2_uint16(A4Target_LeftBottom.x);
//   //   A4Target_LeftBottom.y = mid_Filter2_uint16(A4Target_LeftBottom.y);
//   //   A4Target_LeftTop.x = mid_Filter2_uint16(A4Target_LeftTop.x);
//   //   A4Target_LeftTop.y = mid_Filter2_uint16(A4Target_LeftTop.y);  
//   //   return 0;
//   // }
//   // else
//   // {
...
//   if(findOuterFrame() == 1)
//   {
//     // LCD_DrawLine2(A4Target_RightBottom.x, A4Target_RightBottom.y, A4Target_RightTop.x, A4Target_RightTop.y, 1, RED);
//     // LCD_DrawLine2(A4Target_RightBottom.x, A4Target_RightBottom.y, A4Target_LeftBottom.x, A4Target_LeftBottom.y, 1, RED);
//     // LCD_DrawLine2(A4Target_LeftTop.x, A4Target_LeftTop.y, A4Target_RightTop.x, A4Target_RightTop.y, 1, RED);
//     // LCD_DrawLine2(A4Target_LeftTop.x, A4Target_LeftTop.y, A4Target_LeftBottom.x, A4Target_LeftBottom.y, 1, RED);
//   }
// }
