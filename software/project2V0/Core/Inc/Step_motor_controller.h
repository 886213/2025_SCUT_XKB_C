...
#define StepMotor_speedMAX 999 // 最大速度，对应100Hz，0.1125度/步，即500*0.1125=56.25度/s
#define StepMotor_speedMIN 993 // 最小速度，对应50Hz，0.1125度/步，即100*0.1125=11.25度/s
...
#define StepMotor1_DIR_right HAL_GPIO_WritePin(StepMotor1_DIR_PORT, StepMotor1_DIR_PIN, GPIO_PIN_RESET)
#define StepMotor1_DIR_left HAL_GPIO_WritePin(StepMotor1_DIR_PORT, StepMotor1_DIR_PIN, GPIO_PIN_SET)
#define StepMotor2_DIR_right HAL_GPIO_WritePin(StepMotor2_DIR_PORT, StepMotor2_DIR_PIN, GPIO_PIN_RESET)
#define StepMotor2_DIR_left HAL_GPIO_WritePin(StepMotor2_DIR_PORT, StepMotor2_DIR_PIN, GPIO_PIN_SET)
